        ...
        $base = [
            Forms\Components\Section::make([
                Forms\Components\Select::make('supplier_id')
                    ...
                    ->createOptionForm(Supplier::getForm(products: true))
                    ->editOptionForm(Supplier::getForm(products: true)),
            ...
            Forms\Components\Repeater::make('productPurchases')
                ...
                ->afterStateUpdated(function (Forms\Get $get, Forms\Set $set, $state) {
                    ...
                    $set('order_status', \App\Enums\OrderStatus::Pending->value);
                })
                ->schema([
                    ...
                    Forms\Components\Section::make('Order Info')
                        ...
                        ->schema([
                            ...
                            Forms\Components\DatePicker::make('expected_delivery_date')
                                ...
                                ->disabled(fn (Forms\Get $get): bool => $get('order_status') === \App\Enums\OrderStatus::Received->value)
                                ->dehydrated()
                                ->required(),
