    ...
    <x-filament::section>
        <div class="p-5 space-y-10 relative">
            ...
            <section class="flex items-center justify-between">
                ...
                <div class="absolute flex items-center gap-2 transform-gpu opacity-10 -rotate-45 top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 font-serif font-bold text-8xl text-emerald-600">
